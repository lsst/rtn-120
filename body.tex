...
\label{sec:intro}
\href{https://docs.ragas.io/}{RAGAS} framework \cite{Es2023}
...
Rubin's Community Science Team has already explored using \href{https://vale.sh}{Vale} for automated style verification of user-facing documentation; the chatbot provides a complementary, content-level validation approach.
% ============================================================================
...
\href{https://www.langchain.com}{LangChain} is an open-source Python library that provides the integration layer connecting all three RAG stages.
...
Phalanx is built on a layered infrastructure stack: \href{https://kubernetes.io}{Kubernetes} for container orchestration, \href{https://argo-cd.readthedocs.io}{Argo~CD} for GitOps-based continuous delivery, \href{https://helm.sh}{Helm} for packaging Kubernetes applications, and the \href{https://safir.lsst.io}{Safir} framework for Rubin-specific service development.
...
The Phalanx-based deployment model means that the chatbot's configuration is managed as code in the \href{https://github.com/lsst-sqre/phalanx}{Phalanx repository}, enabling reproducible deployments, version-controlled updates, and rollback capability.
...
software in the \href{https://github.com/lsst-dm/rubin_rag}{\texttt{lsst-dm/rubin\_rag}} GitHub repository.
